...
import com.cts.cms.entity.User;
...
import com.cts.cms.security.JwtTokenProvider;
...
public class UserServiceImpl implements UserService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(userRepository.existsByUsername(registerDto.getUsername())){
            throw new CmsException(HttpStatus.BAD_REQUEST, "Username is already exists!.");
        }
        ...
        if (user.getEmail().contains("@cms.com")){
            userRole = roleRepository.findByName("ROLE_ADMIN").get();
        }
        else {
            userRole = roleRepository.findByName("ROLE_MEMBER").get();
        }
